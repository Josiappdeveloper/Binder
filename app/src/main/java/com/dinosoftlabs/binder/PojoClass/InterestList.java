...
public class InterestList implements Serializable {
    ...
    private final static long serialVersionUID = 2084605549640812109L;
     ...
     * @param deleteDate
     */
    public InterestList(String id, String code, String interestName, String interestValue, Object isPopular, String isActive, Object isDelete, String addID, Object editID, Object deleteID, String addIP, Object editIP, Object deleteIP, String addDate, String editDate, Object deleteDate) {
        super();
        this.id = id;
        this.code = code;
