...
public class ReligionList implements Serializable {
    @SerializedName("id")
    @Expose
    private String id;
    @SerializedName("code")
     ...
     * @param deleteDate
     */
    public ReligionList(String id, String code, String religionName, String isActive, Object isDelete, String addID, String addIP, String addDate, Object editIP, Object editID, Object editDate, Object deleteID, Object deleteIP, Object deleteDate) {
        super();
        this.id = id;
        this.code = code;
