...
public class CasteList implements Serializable {
    @SerializedName("id")
    @Expose
    private String id;
    @SerializedName("code")
     ...
     * @param deleteDate
     */
    public CasteList(String id, String code, String casteName, String isActive, Object isDelete, String addID, String addIP, String addDate, Object editIP, Object editID, Object editDate, Object deleteID, Object deleteIP, Object deleteDate) {
        super();
        this.id = id;
        this.code = code;
