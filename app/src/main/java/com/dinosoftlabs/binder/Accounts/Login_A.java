...
import com.dinosoftlabs.binder.Registration.LoginWithPhoneActivity;
...
public class Login_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED ) {
                ActivityCompat.requestPermissions(Login_A.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 101);
            }
        } catch (Exception e){
            e.printStackTrace();
        }
        ...
        btn_signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it= new Intent(Login_A.this, ContactNumberActivity.class);
                startActivity(it);
            }
        });
    ...
    private void init() {
        ...
        phone_login_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Login_A.this, LoginWithPhoneActivity.class));
    ...
    */
    ...
    public void LoginWithPhone(View view) {
        Intent it= new Intent(Login_A.this, LoginWithPhoneActivity.class);
        startActivity(it);
    }
}
